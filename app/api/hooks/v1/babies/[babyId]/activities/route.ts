    ...
    switch (type as ActivityType) {
      case 'feed': {
        ...
        result = await prisma.feedLog.create({
          data: { time, type: feedType, amount: amount ? parseFloat(amount) : null, unitAbbr: unitAbbr || null, side: side || null, food: food || null, notes: notes || null, bottleType: normalizeBottleType(bottleType), ...timedFields, babyId, caretakerId, familyId },
        });
