...
async function handleGet(req: NextRequest, authContext: AuthResult) {
  try {
    ...
    const [sleepLogs, feedLogs, diaperLogs, pottyLogs, noteLogs, bathLogs, pumpLogs, playLogs, milestoneLogs, measurementLogs, medicineLogs, breastMilkAdjustments, vaccineLogs, photoLogs] = await Promise.all([
