        ...
        {!isExpanded && !isLoading && activities.length > 0 && (
          <StatsTicker 
            stats={[
              ...
              ...(pottyCount !== '0' ? [{ icon: <Toilet className="h-3 w-3 text-fuchsia-600" aria-hidden="true" />, label: "Potty", value: pottyCount }] : []),
        ...
        <div className={dailyStatsStyles.content}>
          {isLoading ? (
            ...
            <>
              ...
              {pottyCount !== '0' && (
                <StatItem
                  icon={<Toilet className="h-4 w-4 text-fuchsia-600" aria-hidden="true" />}
                  label="Potty"
                  value={pottyCount}
                />
              )}
