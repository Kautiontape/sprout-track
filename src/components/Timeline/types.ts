...
export type FilterType = 'sleep' | 'feed' | 'diaper' | 'potty' | 'poop' | 'medicine' | 'note' | 'bath' | 'pump' | 'breast-milk-adjustment' | 'milestone' | 'measurement' | 'play' | 'vaccine' | 'photo' | null;
...
export interface TimelineActivityDetailsProps {
  ...
  onEdit: (activity: ActivityType, type: 'sleep' | 'feed' | 'diaper' | 'potty' | 'medicine' | 'note' | 'bath' | 'pump' | 'breast-milk-adjustment' | 'milestone' | 'measurement' | 'play' | 'vaccine' | 'photo') => void;
